...
import { displayArtistsList, fetchAllArtistsByGenre } from './artists.js';
...
if (!code) {
    ...
    (async () => { 
        try {
            ...
            //populateUI(profile); this shows user information
            ...
            displayGenreList(genres,accessToken);
            //const artists = await fetchAllArtistsByGenre(accessToken);
